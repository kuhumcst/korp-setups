...
var lanchart_leksisxogxfraser = { label: "leksisxogxfraser",
    opts: settings.defaultOptions, 
    order: 78 };
var lanchart_byl_artikel = { label: "byl_artikel",
    opts: settings.defaultOptions, 
    order: 79 };
var lanchart_byl_ikke = { label: "byl_ikke",
    opts: settings.defaultOptions, 
    order: 80 };
var lanchart_byl_jeg = { label: "byl_jeg",
    opts: settings.defaultOptions, 
    order: 81 };
var lanchart_byl_omlyd = { label: "byl_omlyd",
    opts: settings.defaultOptions, 
    order: 82 };
...
settings.corpora.lanchart_amda = {
    id : "lanchart_amda",
    title : "LANCHART_AMDA",
    description : "Korpus af udskrifterne fra Amerikadansk-projektet: AmDa-dana: Danske Stemmer: Optagelser fra sidst i 1990&#x27;erne af danskere udvandret til Californien efter anden verdenskrig. | AmDa-kbl: Danske Stemmer: Optagelser med danske emigranter i Amerika. Kbl er interviewerne, Iver Kjær (XIK) og Mogens Baumann Larsen (XBL). Optagelserne er primært fra 1970&#x27;erne. | AmDa-tk: Danske Stemmer: Samtaler med Tore Kristiansen og danske udvandere i Solvang, Californien. Optaget i 1990.",
    within :  {"text": "text", "sentence": "sentence"},
    context : {"3 sentence": "3 sentence"}, //defaultContext,
    attributes : {
        real_ipa : lanchart_real_ipa,
...
settings.corpora.lanchart_bylderup = {
    ...
    attributes : {
        ...
        byl_artikel : lanchart_byl_artikel,
        byl_ikke : lanchart_byl_ikke,
        byl_jeg : lanchart_byl_jeg,
        byl_omlyd : lanchart_byl_omlyd,
        comments : lanchart_comments,
        events : lanchart_events,
...
settings.corpora.lanchart_danengfam = {
    id : "lanchart_danengfam",
    title : "LANCHART_DANENGFAM",
    description : "Korpus af udskrifterne fra DanEngFam-projektet: DanEngFam: DanEngFam-projektet er et projekt om dansk-engelske familier i Danmark med børn. Projektet beskæftiger sig med sproglige ideologier og praksisser hos dansk-engelsk-sprogede familier som bor i Danmark. For deltagerfamilierne gælder det at de har én forælder som har dansk som sit førstesprog, og én som har engelsk som sit førstesprog. Data er gruppeinterview med begge forældre udført hjemme hos familierne selv. Optagelser fra 2014.",
    within :  {"text": "text", "sentence": "sentence"},
    context : {"3 sentence": "3 sentence"}, //defaultContext,
    attributes : {
        real_ipa : lanchart_real_ipa,
...
settings.corpora.lanchart_hirtshals = {
    ...
    description : "Korpus af udskrifterne fra Hirtshals-projektet: Hirtshals: Optagelser fra 2015 med unge 9.-klasseselever på Hirtshals Skole, samt deres familier.",
    within :  {"text": "text", "sentence": "sentence"},
    context : {"3 sentence": "3 sentence"}, //defaultContext,
    attributes : {
        real_ipa : lanchart_real_ipa,
