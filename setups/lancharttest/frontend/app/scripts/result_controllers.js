    ...
    constructor(scope, timeout, utils, location, kwicDownload) {
        ...
        s.download = {
            options: [
                ...
                { value: "kwic/backendcsv", label: "download_customkwic_backendcsv" },
            ...
            init: (value, hitsDisplay) => {
                if (value === "kwic/backendcsv") {
                    ...
                    const downloadUrl2 = loc_orig + window.location.pathname + "download/csv?" + url_search;
                    // const downloadUrl = "http://localhost:14000/download/csv?default_context=1%20sentence&show=sentence%2Cpos%2Cmsd%2Clemma%2Cref%2Cprefix%2Csuffix&show_struct=text_title&start=0&end=24&corpus=LSPCLIMATEAKTUELNATURVIDENSKAB%2CLSPCLIMATEDMU%2CLSPCLIMATEHOVEDLAND%2CLSPCLIMATEOEKRAAD&cqp=[word%20%3D%20%22mange%22]&query_data=&context=&incremental=true&default_within=sentence&within="; 
